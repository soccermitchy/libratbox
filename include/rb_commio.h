 ...
 *  USA
 *
 *  $Id: rb_commio.h 27377 2012-03-16 06:29:42Z dubkat $
 */
...
int __rb_must_check  rb_ssl_listen(rb_fde_t *, int backlog);
int __rb_must_check rb_listen(rb_fde_t *, int backlog);
